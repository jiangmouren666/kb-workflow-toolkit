...
class BuildStarterTests(unittest.TestCase):
    def test_build_starter_copies_only_template_files(self) -> None:
        ...
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn("00-global/scripts/maintenance-apply.py", files)
            self.assertIn("00-global/scripts/trust-drift-report.py", files)
            ...
            self.assertIn("00-global/scripts/test_maintenance_apply.py", files)
            self.assertIn("00-global/scripts/test_trust_drift_report.py", files)
